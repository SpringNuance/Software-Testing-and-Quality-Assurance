...
## Exercise 7.1: Turn test case into a keyword with arguments
...
_Hint:_ A keyword can take multiple arguments when separating them with 4 spaces.
...
_Note:_ the commented line (one starting with `#`) isn't required. It's there merely to server as a
...
## Exercise 7.2: Create 4 more test cases
